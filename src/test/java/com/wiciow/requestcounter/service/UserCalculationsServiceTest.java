...
class UserCalculationsServiceTest {
  ...
  void testIfCalculationsAreCorrect(Integer followers,
                                    Integer publicRepos,
                                    BigDecimal expected) {
    //given
  ...
  private static Stream<Arguments> getUserCalculations() {
    return Stream.of(
        arguments(1, 1, BigDecimal.valueOf(18)
            .setScale(2, RoundingMode.HALF_UP)),
        arguments(1, 0, BigDecimal.valueOf(12)
            .setScale(2, RoundingMode.HALF_UP)),
        arguments(6, 0, BigDecimal.valueOf(2)
            .setScale(2, RoundingMode.HALF_UP)),
        arguments(12, 0, BigDecimal.valueOf(1)
            .setScale(2, RoundingMode.HALF_UP)),
        arguments(9, 0, BigDecimal.valueOf(1.34)
            .setScale(2, RoundingMode.HALF_UP)),
        arguments(10472, 8, BigDecimal.valueOf(0)
            .setScale(2, RoundingMode.HALF_UP)),
        arguments(0, 999, BigDecimal.valueOf(0)
            .setScale(2, RoundingMode.HALF_UP))
    );
  }
